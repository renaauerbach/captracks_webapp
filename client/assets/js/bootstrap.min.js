  ...
  const ct = "collapse",
      ...
      bt = function() {
          function a(e, t) {
              ...
              for (let n = [].slice.call(document.querySelectorAll(St)), i = 0, o = n.length; i < o; i++) {
                  const r = n[i],
  ...
  const It = "dropdown",
      ...
      Jt = function() {
          ...
          return t.toggle = function() {
              ...
              let e, n = _.getSelectorFromElement(t);
      ...
      Be = function() {
          ...
          return t.enable = function() {
              ...
              if (this.isWithContent() && this._isEnabled) {
                  ...
                  const s = "function" === typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
      ...
      Kn = function() {
          ...
          return t.show = function() {
              ...
              if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass(Pn) || g(this._element).hasClass(Ln))) {
                  let t, i, e = g(this._element).closest(xn)[0],
                      o = _.getSelectorFromElement(this._element);
                  if (e) {
                      const r = "UL" === e.nodeName || "OL" === e.nodeName ? Un : Fn;
                      i = (i = g.makeArray(g(e).find(r)))[i.length - 1];
                  }
                  const s = g.Event(On.HIDE, {
                          relatedTarget: this._element
                      }),
                      a = g.Event(On.SHOW, {
                          relatedTarget: i
